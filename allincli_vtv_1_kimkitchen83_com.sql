...
--
-- Host: localhost:3306
-- Generation Time: May 18, 2024 at 05:12 PM
...
--
-- Database: `allincli_vtv_1_kimkitchen83_com`
--
...
CREATE TABLE `login` (
  `owner` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `theme` (
  `theme` int NOT NULL,
  `detail` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `bgcolor` varchar(10) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
